/**
 * The {@code Huffman} class implements huffman algorithm.
 * Compress or expand files using the Huffman algorithm.
 *
 * @author Ahmed Jouda
 */
package Assignment;
...
* Results Analysis found in the same repository "AssignmentDoc.pdf"
*
******************************************************************************/

/**
 * Huffman coding tries to optimize the alphabet by choosing a representation
 * for each symbol, resulting in a prefix code that expresses the most common
 * symbols using shorter strings of bits than are used for less common symbols.
 * This way, most of the structure and redundancy have been squeezed out.
 *
 *
 * @author Ahmed Jouda
 */
public class Huffman {
	...
	public static void main(String[] args) {
		...
		// Check if it is a compress or decompress command
		// Time the process and display the result
		// If wrong command throw an illegal argument exception
